...
<body>
	<h2 class="sub-header" style="padding-left: 1em">用户权限设置</h2>
	...
	<form action="AuthorityOption" method="post" name="myForm">
			...
			<table align="center" class="table table-striped">
				<tbody>
					<tr>
						...
						<td align="left"><select name="role" id="role"
							class="selector">
					...
					%>
					<tr>
						<td align="right"><%=AuthorityClass%>：</td>
						<td></td>
					</tr>
					<%
		...
		<center>
			<p>
				<input type="submit" value="提交" class="btn btn-primary" />&emsp;&emsp;<input
