...
<script type="text/javascript">
	...
	function aa() {
		if (myForm.shidao.value == "" || myForm.qingjia.value == ""
				|| myForm.absent.value == "") {
			alert("请先统计人数");
		} else {
			myForm.submit();
...
<body>
	<h2 class="sub-header" style="padding-left: 1em">会议考勤</h2>
	<hr>
	<form action="MeetingCheck" method="post" name="myForm">
		<table align="center" width=“80%” class="table table-striped">
			<tbody>
				<tr>
					...
					<td align="left" colspan="3"><select name="department"
						id="department" class="selector">
					...
					<td align="left" colspan="3"><input type="text"
						name="meeting_date" value="<%=matter1.format(dt)%>"
						readonly="readonly" /></td>
				</tr>
				<tr>
					<td align="right">会议主题：</td>
					<td align="left" colspan="7"><input type="text"
						name="meeting_theme" size="66" /></td>
				</tr>
				<tr>
					<td align="right">应到人数：</td>
					<td align="left" colspan="3"><input type="text" name="yingdao"
						value="" /></td>
					<td align="right">实到人数：</td>
					<td align="left" colspan="3"><input type="text" name="shidao" />
					</td>
				</tr>
				<tr>
					<td align="right">请假人数：</td>
					<td align="left" colspan="3"><input type="text" name="qingjia" />
					</td>
					<td align="right">缺勤人数：</td>
					<td align="left" colspan="3"><input type="text" name="absent" />
					</td>
				</tr>
				<tr>
		...
		<center>
			<input type="button" onclick="myFunction()" value="统计人数"
				class="btn btn-primary" />&emsp;&emsp;&emsp;&emsp;<input
				type="button" onclick="aa()" value="确认提交" class="btn btn-primary" />&emsp;&emsp;&emsp;&emsp;<input
